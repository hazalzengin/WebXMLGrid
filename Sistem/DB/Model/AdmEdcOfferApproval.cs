...
{
    /// <summary>
    /// ADM_EDC_OFFER_APPROVAL için base classý
    /// </summary>
    [Serializable]
    [TableName("ADM_EDC_OFFER_APPROVAL")]
    public class AdmEdcOfferApproval
    {

        #region Constructor

        public AdmEdcOfferApproval()
        {
        ...
        [PK]
        [Identity("AdmEdcOfferApproval_seq")]
        [Field("ID")]
