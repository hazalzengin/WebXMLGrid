...
{
    /// <summary>
    /// ADM_EDC_OFFERCREDIT_APPROVAL için base classý
    /// </summary>
    [Serializable]
    [TableName("ADM_EDC_OFFERCREDIT_APPROVAL")]
    public class AdmEdcOffercreditApproval : BaseModel
    {

        #region Constructor

        public AdmEdcOffercreditApproval()
        {
        ...
        [PK]
        [Identity("AdmEdcOffercreditApproval_seq")]
        [Field("ID")]
