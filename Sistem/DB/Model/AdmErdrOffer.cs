...
{
    /// <summary>
    /// ADM_ERDR_OFFER için base classý
    /// </summary>
    [Serializable]
    [TableName("ADM_ERDR_OFFER")]
    public class AdmErdrOffer : BaseModel
    {
        ...
        [Field("OPRMNGCODE")]
        [ParameterType(DbType.String)]
        public string OperationsManagerCode { get; set; }

        [Field("OPRMNGDEF")]
        [ParameterType(DbType.String)]
        public string OperationsManagerDef { get; set; }
        ...
        [Field("SECTORCODE")]
        [ParameterType(DbType.Int32)]
        public int? AnaSektorKodu { get; set; }
