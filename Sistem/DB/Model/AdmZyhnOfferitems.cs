...
{
    /// <summary>
    /// ADM_ZYHN_OFFERITEMS için base classý
    /// </summary>
    [Serializable]
    [TableName("ADM_ZYHN_OFFERITEMS")]
    public class AdmZyhnOfferitems : BaseModel
    {

        #region Constructor

        public AdmZyhnOfferitems()
        {
        ...
        [PK]
        [Identity("AdmZyhnOfferitems_seq")]
        [Field("ID")]
