...
{
    /// <summary>
    /// ADM_ZYHN_OFFER_APPROVAL için base classý
    /// </summary>
    [Serializable]
    [TableName("ADM_ZYHN_OFFER_APPROVAL")]
    public class AdmZyhnOfferApproval : BaseModel
    {

        #region Constructor

        public AdmZyhnOfferApproval()
        {
        ...
        [PK]
        [Identity("AdmZyhnOfferApproval_seq")]
        [Field("ID")]
