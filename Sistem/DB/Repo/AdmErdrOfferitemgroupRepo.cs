...
{
    public class AdmErdrOfferitemgroupRepo:BaseRepository<AdmErdrOfferitemgroup> 
    {

        public List<AdmErdrOfferitemgroup> GetItemClass(int? Id, int? Offerref, int? Isactive, int? Isdel)
        {
            var query = new FrQueryBase(dbo);
            query.From("ADM_ERDR_OFFERITEMGROUP");
            ...
            return query.ToDataSet().ToFrList<AdmErdrOfferitemgroup>();
        }

        public DataSet GetAll(int? Id, int? Offerref, int? Isactive, int? Isdel)
        {
            var query = new FrQueryBase(dbo);
            query.From("ADV_ERDR_OFFERITEMGROUP");
